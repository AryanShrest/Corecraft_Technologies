    ...
    <footer className="relative overflow-hidden bg-gradient-to-b from-[#0a1638] via-[#0a1940] to-[#07102d] text-white">
      ...
      <div className="absolute inset-0 opacity-[0.08]">
        <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
          <title>footer decorative pattern</title>
          <defs>
          ...
          <div className="relative grid md:grid-cols-5 gap-6 items-center px-6 md:px-10 py-7 md:py-9">
            <div className="md:col-span-2 flex items-center gap-4">
              <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-white/15 backdrop-blur border border-white/20 flex items-center justify-center">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><title>mail icon</title><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
              </div>
              <div>
            ...
            >
              <div className="flex-1 relative">
                <svg className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-blue-200/80" fill="none" stroke="currentColor" viewBox="0 0 24 24"><title>user circle</title><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 12a4 4 0 10-8 0 4 4 0 008 0zm0 0v1.5a2.5 2.5 0 005 0V12a9 9 0 10-9 9m4.5-1.206a8.959 8.959 0 01-4.5 1.207" /></svg>
                <input
                  type="email"
                  required
                  value={email}
              ...
              {subscribed && (
                <span className="hidden md:flex absolute right-40 md:right-60 top-16 items-center gap-2 text-xs text-green-300">
                  <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><title>success</title><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                  Subscribed!
                </span>
              )}
            </form>
          ...
          <div className="lg:col-span-2 space-y-5">
            ...
            <div className="space-y-2.5 text-sm text-blue-100/90 max-w-sm">
              <div className="flex items-start gap-3">
                <svg className="w-4 h-4 mt-0.5 flex-shrink-0 text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><title>clock icon</title><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                <span>10:00 AM - 6:00 PM / Sat - Fri</span>
              </div>
              <div className="flex items-start gap-3">
                <svg className="w-4 h-4 mt-0.5 flex-shrink-0 text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><title>phone icon</title><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                <span>Support: 980-0000000</span>
              </div>
              <div className="flex items-start gap-3">
                <svg className="w-4 h-4 mt-0.5 flex-shrink-0 text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><title>mail icon</title><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
            ...
            <div className="flex items-center gap-2.5 pt-1">
              {[
                { label: 'Twitter', path: 'M12 2a10 10 0 100 20 10 10 0 000-20z' },
                { label: 'LinkedIn', path: 'M12 2a10 10 0 100 20 10 10 0 000-20z' },
                { label: 'Facebook', path: 'M12 2a10 10 0 100 20 10 10 0 000-20z' },
              ].map((s) => (
                <a
                  key={s.label}
                  href={`https://www.${String(s.label).toLowerCase().replace(/\s+/g, '')}.com`}
                  aria-label={s.label}
                ...
                >
                  <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor"><title>{`${s.label} icon`}</title>
                    <path d={s.path} />
                  </svg>
                </a>
              ))}
